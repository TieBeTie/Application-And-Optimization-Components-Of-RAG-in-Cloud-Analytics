Can we balance the length of the RAG relationships? In LeanRAG there are 3 levels of hierarchy, they fixed, but what if there is more effective way to define the right number of levels? 
